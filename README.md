...
Open `https://<your-username>.github.io/<repo-name>/` with Ollama running. The status dot turns teal once it connects. Click the gear icon to change the address or model — e.g. point it at a bigger local model, or later at a cloud box running a larger model, without touching the code.
